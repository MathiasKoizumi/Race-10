...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		public void violenceNearby()
		{
			...
			{
				int num4 = junkie.Next(5, 10);
				double num5 = junkie.NextDouble() + 0.1;
				gfx.DrawImage(image, new Rectangle(new Point(junkie.Next(800), junkie.Next(300)), new Size(new Point((int)((double)image.Width / ((double)num4 * num5)), (int)((double)image.Height / ((double)num4 * num5))))));
			...
			for (int k = 0; k < junkie.Next(50, 200); k++)
			{
				...
				double num6 = junkie.NextDouble() + 0.1;
				int num7 = junkie.Next(1, 10);
				gfx.DrawImage(image, new Rectangle(new Point(num + (int)(400.0 * Math.Sin(junkie.Next(10000))), num2 + (int)(200.0 * Math.Sin(junkie.Next(10000)))), new Size(new Point((int)((double)image.Width * num6) / num7, (int)((double)image.Height * num6) / num7))));
				Thread.Sleep(junkie.Next(100));
			}
			num = junkie.Next(800);
			num2 = junkie.Next(650);
